...
if [ -d "$OLD_VENV_DIR" ] && [ ! -d "$VENV_DIR" ]; then
    ...
    BAKED_NODES="ComfyUI-Manager ComfyUI-KJNodes Civicomfy ComfyUI-RunpodDirect ComfyUI-Impact-Pack ComfyUI-Impact-Subpack ComfyUI-Easy-Use efficiency-nodes-comfyui"
    CURRENT=0
    INSTALLED=0
